...
import { useUrlUpdateMutation } from "@/lib/modules/url/url.query";
...
type TProps = {
  defaultValues: Pick<TUrl, "name" | "url">;
};
...
const UrlUpdateForm = ({ defaultValues }: TProps) => {
  ...
  const { mutateAsync: updateUrl, isPending } = useUrlUpdateMutation();
  ...
  return (
    <Form {...form}>
      ...
      >
        <h1 className="text-3xl font-semibold mb-8">Update URL</h1>
        <FormField
